...
const styles = StyleSheet.create({
  ...
  stepLabel: {
    ...
    color: "#333", paddingHorizontal: 16, paddingVertical: 10,
  },
  ...
  chip: {
    borderWidth: 2, borderColor: "#2e7d32", borderRadius: 12,
    paddingHorizontal: 14, paddingVertical: 10,
    marginRight: 10, minWidth: 150, marginBottom: 8,
  },
  ...
  volunteerCard: {
    ...
    marginBottom: 10, borderRadius: 12, padding: 14,
  ...
  input: {
    ...
    padding: 12, marginBottom: 14, fontSize: 14,
